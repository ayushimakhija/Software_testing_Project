...
public class Main {
    ...
    InitializingBean sendDatabase(){
        return ()->{
            ...
            customerRepository.save(new Customer("ayushi","makhija","7869054251","narsinghpur","ayushi9ym.19@gmail.com","ayushi",true));
            ...
            customerRepository.save(new Customer("divyansha","agarwal","3456789012","indore","divyansha@gmail.com","divyansha",false));
             ...
             f1 =  new foodprovider("ayushi9yb.19@gmail.com","ayushi","bangalore","ayushi Cafe","7869054251");
            foodproviderRepository.save(f1);

             f2 = new foodprovider("pavan@gmail.com","pavan","chennai","Pavan Tifffins","8686886135");
            foodproviderRepository.save(f2);

            foodprovider f3 =  new foodprovider("shabbir@gmail.com","shabbir","chennai","SS Chicken Biryani","7823456789");
